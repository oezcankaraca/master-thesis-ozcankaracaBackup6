...
# Flags to indicate whether super-peers are used and the number of peers in the testbed
HAS_SUPERPEER="true"
NUMBER_OF_PEERS_ARG="10"
...
TEST_ID_FILE="$BASISPFAD/master-thesis-ozcankaraca/data-for-testbed/results/test_id_counter.txt"
...
CSV_PATH="$BASISPFAD/master-thesis-ozcankaraca/data-for-testbed/results/results-testbed.csv"
